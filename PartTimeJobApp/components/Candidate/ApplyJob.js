  ...
  const renderOcrData = () => {
    ...
    return (
      <View style={styles.ocrDataContainer}>
        <Text style={styles.ocrTitle}>Thông tin từ giấy tờ tùy thân</Text>

        {ocrData.firstName && (
          <View style={styles.ocrRow}>
            <Text style={styles.ocrLabel}>Họ:</Text>
            <Text style={styles.ocrValue}>{ocrData.firstName}</Text>
          </View>
        )}

        {ocrData.lastName && (
          <View style={styles.ocrRow}>
            <Text style={styles.ocrLabel}>Tên:</Text>
            <Text style={styles.ocrValue}>{ocrData.lastName}</Text>
          </View>
        )}

        {ocrData.fullName && (
          <View style={styles.ocrRow}>
            <Text style={styles.ocrLabel}>Họ và tên:</Text>
            <Text style={styles.ocrValue}>{ocrData.fullName}</Text>
          </View>
        )}

        {ocrData.dob && (
          <View style={styles.ocrRow}>
            <Text style={styles.ocrLabel}>Ngày sinh:</Text>
            <Text style={styles.ocrValue}>{formatDate(ocrData.dob)}</Text>
          </View>
        )}

        {ocrData.sex && (
          <View style={styles.ocrRow}>
            <Text style={styles.ocrLabel}>Giới tính:</Text>
            <Text style={styles.ocrValue}>{ocrData.sex === 'M' ? 'Nam' : 'Nữ'}</Text>
          </View>
        )}

        {ocrData.address1 && (
          <View style={styles.ocrRow}>
            <Text style={styles.ocrLabel}>Địa chỉ:</Text>
            <Text style={styles.ocrValue}>{ocrData.address1}</Text>
          </View>
        )}

        {ocrData.expiry && (
          <View style={styles.ocrRow}>
            <Text style={styles.ocrLabel}>Ngày hết hạn:</Text>
            <Text style={styles.ocrValue}>{formatDate(ocrData.expiry)}</Text>
          </View>
        )}

        {ocrData.age && (
          <View style={styles.ocrRow}>
            <Text style={styles.ocrLabel}>Tuổi:</Text>
            <Text style={styles.ocrValue}>{ocrData.age}</Text>
          </View>
        )}
      </View>
    );
